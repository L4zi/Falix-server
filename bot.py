...
SUBDOMAIN = os.getenv("hamaratwoweekphase")
...
**`requirements.txt`** — paste this exactly:
```
discord.py>=2.3.0
```
...
**`Procfile`** (no file extension at all, just `Procfile`) — paste this exactly:
```
